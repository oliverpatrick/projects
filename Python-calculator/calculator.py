...
class Calculator:
    ...
    def __init__(self,master):
        ...
        self.entry = Entry(frame_s,textvariable=self.var,bg='grey',width=45,bd=20,insertwidth=4,justify='right',font=('arial',5,'bold'))
        self.entry.pack()
        self.t = Text(self.entry,height=40)



        label_key = Label(root, height=15, width=30,bd=5,bg='gray50')
        ...
        label_9.grid(row=0, column=2, padx=5)
        ...
        label_4.grid(row=1, column=0, padx=5, pady=5)
        ...
        label_5.grid(row=1, column=1, padx=5, pady=5)
        ...
        label_6.grid(row=1, column=2, padx=5, pady=5)
        ...
        label_3.grid(row=2, column=2, padx=5)
        ...
        label_0.grid(row=3, column=0, padx=5, pady=5)
        ...
        label_deci.grid(row=3, column=1, padx=5, pady=5)
        ...
        label_equal.grid(row=3, column=2, padx=5, pady=5)
        ...
        button_C = Button(label_C, text='C', font=('Helvetica', '16'), height=1, width=5,command=  self.clear,bg='black',fg='cyan')
        button_C.pack(side=LEFT)

        label_sub = Label(label_fkey, bg='black')
        label_sub.grid(row=1, column=0, sticky=W, pady=5)
        ...
        label_lbrace.grid(row=3,column=0,sticky=W,pady=5)
        ...
        label_rbrace.grid(row=3, column=1, sticky=E, pady=5)
