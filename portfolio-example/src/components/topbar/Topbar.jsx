...
const Link = ({
  ...
  return (
    ...
    >
      <span id="icon">{isPhone ? icon : ""}</span>
...
export default function Topbar({ toShow, activePage, setActivePage, isPhone }) {
  return (
    <CSSTransition in={toShow} timeout={400} classNames="topbar">
      <div className="topbar">
        <div className="wrapper">
          <div className="left">
            <a href="#intro">
              <h1 color="secondary">
                <b className="orange">OH</b>
              </h1>
            </a>
          </div>
